...
Jet generator can be installed in one of the following ways:
 ...
 1. (Go1.16+) Install jet generator using go install:
    go install github.com/goranbjelanovic/jet/v2/cmd/jet@latest

 2. Install jet generator to GOPATH/bin folder:
    cd $GOPATH/src/ && GO111MODULE=off go get -u github.com/goranbjelanovic/jet/cmd/jet

 3. Install jet generator into specific folder:
    git clone https://github.com/goranbjelanovic/jet.git
...
To write postgres SQL queries we import:
	...
	. "github.com/goranbjelanovic/jet/v2/postgres" // Dot import is used so that Go code resemble as much as native SQL. It is not mandatory.
